...
final $typed_data.Uint8List versionDescriptor = $convert.base64Decode(
    'CgdWZXJzaW9uEhgKB3ZlcnNpb24YASABKA1SB3ZlcnNpb24SGAoHcmVsZWFzZRgCIAEoCVIHcmVsZWFzZRIOCgJvcxgDIAEoCVICb3MSHQoKb3NfdmVyc2lvbhgEIAEoCVIJb3NWZXJzaW9u');
...
final $typed_data.Uint8List uDPTunnelDescriptor =
    $convert.base64Decode('CglVRFBUdW5uZWwSFgoGcGFja2V0GAEgAigMUgZwYWNrZXQ=');
...
final $typed_data.Uint8List authenticateDescriptor = $convert.base64Decode(
    'CgxBdXRoZW50aWNhdGUSGgoIdXNlcm5hbWUYASABKAlSCHVzZXJuYW1lEhoKCHBhc3N3b3JkGAIgASgJUghwYXNzd29yZBIWCgZ0b2tlbnMYAyADKAlSBnRva2VucxIjCg1jZWx0X3ZlcnNpb25zGAQgAygFUgxjZWx0VmVyc2lvbnMSGQoEb3B1cxgFIAEoCDoFZmFsc2VSBG9wdXM=');
...
final $typed_data.Uint8List pingDescriptor = $convert.base64Decode(
    '');
...
const Reject$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.MumbleProto.Reject.RejectType',
      '10': 'type'
    },
...
final $typed_data.Uint8List rejectDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List serverSyncDescriptor = $convert.base64Decode(
    'CgpTZXJ2ZXJTeW5jEhgKB3Nlc3Npb24YASABKA1SB3Nlc3Npb24SIwoNbWF4X2JhbmR3aWR0aBgCIAEoDVIMbWF4QmFuZHdpZHRoEiEKDHdlbGNvbWVfdGV4dBgDIAEoCVILd2VsY29tZVRleHQSIAoLcGVybWlzc2lvbnMYBCABKARSC3Blcm1pc3Npb25z');
...
const ChannelState$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'is_enter_restricted',
      '3': 12,
      '4': 1,
      '5': 8,
      '10': 'isEnterRestricted'
    },
...
final $typed_data.Uint8List channelStateDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List userRemoveDescriptor = $convert.base64Decode(
    'CgpVc2VyUmVtb3ZlEhgKB3Nlc3Npb24YASACKA1SB3Nlc3Npb24SFAoFYWN0b3IYAiABKA1SBWFjdG9yEhYKBnJlYXNvbhgDIAEoCVIGcmVhc29uEhAKA2JhbhgEIAEoCFIDYmFu');
...
const UserState$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'temporary_access_tokens',
      '3': 20,
      '4': 3,
      '5': 9,
      '10': 'temporaryAccessTokens'
    },
    const {
      '1': 'listening_channel_add',
      '3': 21,
      '4': 3,
      '5': 13,
      '10': 'listeningChannelAdd'
    },
    const {
      '1': 'listening_channel_remove',
      '3': 22,
      '4': 3,
      '5': 13,
      '10': 'listeningChannelRemove'
    },
  ],
};
...
final $typed_data.Uint8List userStateDescriptor = $convert.base64Decode(
    '');
...
const BanList$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.MumbleProto.BanList.BanEntry',
      '10': 'bans'
    },
...
final $typed_data.Uint8List banListDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List textMessageDescriptor = $convert.base64Decode(
    'CgtUZXh0TWVzc2FnZRIUCgVhY3RvchgBIAEoDVIFYWN0b3ISGAoHc2Vzc2lvbhgCIAMoDVIHc2Vzc2lvbhIdCgpjaGFubmVsX2lkGAMgAygNUgljaGFubmVsSWQSFwoHdHJlZV9pZBgEIAMoDVIGdHJlZUlkEhgKB21lc3NhZ2UYBSACKAlSB21lc3NhZ2U=');
...
const PermissionDenied$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.MumbleProto.PermissionDenied.DenyType',
      '10': 'type'
    },
...
final $typed_data.Uint8List permissionDeniedDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List aCLDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List cryptSetupDescriptor = $convert.base64Decode(
    'CgpDcnlwdFNldHVwEhAKA2tleRgBIAEoDFIDa2V5EiEKDGNsaWVudF9ub25jZRgCIAEoDFILY2xpZW50Tm9uY2USIQoMc2VydmVyX25vbmNlGAMgASgMUgtzZXJ2ZXJOb25jZQ==');
...
const ContextActionModify$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.MumbleProto.ContextActionModify.Operation',
      '10': 'operation'
    },
  ],
  '4': const [
    ContextActionModify_Context$json,
    ContextActionModify_Operation$json
  ],
};
...
final $typed_data.Uint8List contextActionModifyDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List contextActionDescriptor = $convert.base64Decode(
    'Cg1Db250ZXh0QWN0aW9uEhgKB3Nlc3Npb24YASABKA1SB3Nlc3Npb24SHQoKY2hhbm5lbF9pZBgCIAEoDVIJY2hhbm5lbElkEhYKBmFjdGlvbhgDIAIoCVIGYWN0aW9u');
...
final $typed_data.Uint8List userListDescriptor = $convert.base64Decode(
    'CghVc2VyTGlzdBIwCgV1c2VycxgBIAMoCzIaLk11bWJsZVByb3RvLlVzZXJMaXN0LlVzZXJSBXVzZXJzGnMKBFVzZXISFwoHdXNlcl9pZBgBIAIoDVIGdXNlcklkEhIKBG5hbWUYAiABKAlSBG5hbWUSGwoJbGFzdF9zZWVuGAMgASgJUghsYXN0U2VlbhIhCgxsYXN0X2NoYW5uZWwYBCABKA1SC2xhc3RDaGFubmVs');
...
const VoiceTarget$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.MumbleProto.VoiceTarget.Target',
      '10': 'targets'
    },
  ],
...
final $typed_data.Uint8List voiceTargetDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List permissionQueryDescriptor = $convert.base64Decode(
    'Cg9QZXJtaXNzaW9uUXVlcnkSHQoKY2hhbm5lbF9pZBgBIAEoDVIJY2hhbm5lbElkEiAKC3Blcm1pc3Npb25zGAIgASgNUgtwZXJtaXNzaW9ucxIbCgVmbHVzaBgDIAEoCDoFZmFsc2VSBWZsdXNo');
...
final $typed_data.Uint8List codecVersionDescriptor = $convert.base64Decode(
    'CgxDb2RlY1ZlcnNpb24SFAoFYWxwaGEYASACKAVSBWFscGhhEhIKBGJldGEYAiACKAVSBGJldGESJwoMcHJlZmVyX2FscGhhGAMgAigIOgR0cnVlUgtwcmVmZXJBbHBoYRIZCgRvcHVzGAQgASgIOgVmYWxzZVIEb3B1cw==');
...
const UserStats$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'strong_certificate',
      '3': 18,
      '4': 1,
      '5': 8,
      '7': 'false',
      '10': 'strongCertificate'
    },
...
final $typed_data.Uint8List userStatsDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List requestBlobDescriptor = $convert.base64Decode(
    'CgtSZXF1ZXN0QmxvYhInCg9zZXNzaW9uX3RleHR1cmUYASADKA1SDnNlc3Npb25UZXh0dXJlEicKD3Nlc3Npb25fY29tbWVudBgCIAMoDVIOc2Vzc2lvbkNvbW1lbnQSLwoTY2hhbm5lbF9kZXNjcmlwdGlvbhgDIAMoDVISY2hhbm5lbERlc2NyaXB0aW9u');
...
const ServerConfig$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'image_message_length',
      '3': 5,
      '4': 1,
      '5': 13,
      '10': 'imageMessageLength'
    },
...
final $typed_data.Uint8List serverConfigDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List suggestConfigDescriptor = $convert.base64Decode(
    'Cg1TdWdnZXN0Q29uZmlnEhgKB3ZlcnNpb24YASABKA1SB3ZlcnNpb24SHgoKcG9zaXRpb25hbBgCIAEoCFIKcG9zaXRpb25hbBIgCgxwdXNoX3RvX3RhbGsYAyABKAhSCnB1c2hUb1RhbGs=');
...
final $typed_data.Uint8List pluginDataTransmissionDescriptor =
    $convert.base64Decode(
        'ChZQbHVnaW5EYXRhVHJhbnNtaXNzaW9uEiQKDXNlbmRlclNlc3Npb24YASABKA1SDXNlbmRlclNlc3Npb24SLgoQcmVjZWl2ZXJTZXNzaW9ucxgCIAMoDUICEAFSEHJlY2VpdmVyU2Vzc2lvbnMSEgoEZGF0YRgDIAEoDFIEZGF0YRIWCgZkYXRhSUQYBCABKAlSBmRhdGFJRA==');
